...
//        Account ac = new Account();
        ...
        if (a == null) {
            ...
            Customer customer = d.getCustomerByAccount(a.getUsername());
            if (customer != null) {
                d.addOrder(customer, cart);
            }
//            d.addOrder(d.getCustomerByAccount(a.getUserid()), cart);
            Cookie c = new Cookie("cart" + a.getUsername(), "");
            c.setMaxAge(0);
            response.addCookie(c);
            request.setAttribute("out", "Mua hàng thành công");
