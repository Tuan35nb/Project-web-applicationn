<%-- 
    Document   : account
    Created on : Feb 27, 2024, 9:20:46 PM
    Author     : ASUS
--%>
    ...
    <body>
        ...
        <header class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div id="cart"><a class="btn btn-1" href="cart"><span class="glyphicon glyphicon-shopping-cart"></span>Giỏ Hàng : 0 ITEM</a></div>
                </div>
            </div>
        </header>
        <!--Navigation-->
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form name="form1" id="ff1" method="post" action="account">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="Username :" name="user" id="username" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-md-6">
                        ...
                        <form name="form2" id="ff2" method="post" action="create">
                            <div class="form-group">
